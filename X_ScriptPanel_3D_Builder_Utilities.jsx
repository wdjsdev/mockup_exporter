...
function ScriptPanel ()
{
    ...
    var SCRIPTFOLDERS, FAVORITES, networkScriptPath;
    ...
    {
        //PC
        networkScriptPath = "//boombah.local/";
    } else
    {
        // MAC
        networkScriptPath = "/Volumes/"
    }
    networkScriptPath += "shares/Customization/Library/Scripts/";
    SCRIPTFOLDERS = [
        { name: "3D Mockup Exporter", folderPath: networkScriptPath + "mockup_exporter_scripts/", square: "square_none", notes: "" },
    ]
    FAVORITES = [];
    ...
    function runScriptFromFile ( file )
    {
        ...
        customizationPath = sf.fsName.match( /^.*Customization\// )[ 0 ];
    ...
    function miniTab ()
    {
        var title = ( SETTINGS.windowGraphics ) ? '' : '3D Mockup Exporter Scripts';
    ...
    function paletteWindow ()
    {
        ...
        var w = new Window( windowType, 'Development Scripts', undefined, { closeButton: true } );
